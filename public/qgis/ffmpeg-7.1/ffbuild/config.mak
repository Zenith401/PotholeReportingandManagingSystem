...
CFLAGS=   -std=c17 -Werror=partial-availability -mdynamic-no-pic -fomit-frame-pointer -fPIC -I/opt/local/include -I/opt/local/include -pthread -I/opt/local/include -I/opt/local/include -I/opt/local/include -I/opt/local/include -I/opt/local/include -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -D_THREAD_SAFE -I/opt/local/include -I/opt/local/include/SDL2
...
CFLAGS-ffplay=-D_THREAD_SAFE -I/opt/local/include -I/opt/local/include/SDL2
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-framework Foundation -framework AudioToolbox -framework CoreAudio -lm -framework AVFoundation -framework CoreVideo -framework CoreMedia -framework CoreGraphics -L/opt/local/lib -lxcb -L/opt/local/lib -lxcb-shm -L/opt/local/lib -lxcb-shape -L/opt/local/lib -lxcb-xfixes -framework AudioToolbox -pthread -L/opt/local/lib -lSDL2
...
EXTRALIBS-avformat=-lm -lbz2 -L/opt/local/lib -lz -framework CoreFoundation -framework Security
EXTRALIBS-avcodec=-lm -llzma -framework AudioToolbox -pthread -L/opt/local/lib -lz -framework VideoToolbox -framework CoreFoundation -framework CoreMedia -framework CoreVideo -framework CoreServices
EXTRALIBS-swresample=-lm
EXTRALIBS-avutil=-pthread -lm -framework VideoToolbox -L/opt/local/lib -lX11 -framework CoreFoundation -framework CoreMedia -framework CoreVideo -framework CoreServices
EXTRALIBS-ffplay=-L/opt/local/lib -lSDL2
EXTRALIBS-ffprobe=
EXTRALIBS-ffmpeg=
EXTRALIBS-cpu_init=-pthread
EXTRALIBS-cws2fws=-L/opt/local/lib -lz
ARCH_AARCH64=yes
!ARCH_ARM=yes
!ARCH_IA64=yes
!ARCH_LOONGARCH=yes
